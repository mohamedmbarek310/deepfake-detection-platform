  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <nav className="border-b border-white/10 backdrop-blur-sm sticky top-0 z-50
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-6">
            <Link to="/upload" className="text-blue-400 font-semibold">
              Upload
            </Link>
      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        ...
        ─────────────────────────────────────────────────────────────── */}
        {loading ? (
          <div className="bg-white/5 backdrop-blur-sm border border-blue-500/30
            ...
            <p className="text-gray-400 mb-2">{statusText}</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-3 mt-8">
              {[
                ...
                <div key={i}
                  ...
                  <step.icon className="w-5 h-5 text-blue-400 mx-auto mb-2" />
              ...
              <div {...getRootProps()}
                ...
                <div className="text-center">
                  ...
                  <div className="flex flex-wrap justify-center gap-2 text-xs
                                  text-gray-500">
                    <span className="px-3 py-1 bg-white/5 rounded-full">MP4</span>
                    <span className="px-3 py-1 bg-white/5 rounded-full">AVI</span>
                    <span className="px-3 py-1 bg-white/5 rounded-full">MOV</span>
                    <span className="px-3 py-1 bg-white/5 rounded-full">JPG</span>
                    <span className="px-3 py-1 bg-white/5 rounded-full">PNG</span>
                    <span className="px-3 py-1 bg-white/5 rounded-full">GIF</span>
                  </div>
                </div>
              </div>
            )}
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between p-4
                  ...
                  <div className="flex items-center gap-3 min-w-0 flex-1">
                    {isVideo ? (
                      <FileVideo className="w-8 h-8 text-blue-400 flex-shrink-0" />
                    ) : (
